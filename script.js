    ...
    function createProjectHTML(project, visibleSkillsCount, showMoreText) {
      ...
      const linksHTML = `
        <div class="flex items-center gap-0.5 ml-1">
          ${project.github ? `
            <a href="${project.github}" target="_blank" rel="noopener noreferrer" class="p-0.5 rounded-full hover:bg-white hover:bg-opacity-10 transition-colors">
              <img src="public/icons/github.svg" alt="GitHub" class="h-3.5 w-3.5" width="14" height="14">
            </a>
          ` : ''}
          ${project.demo ? `
            <a href="${project.demo}" target="_blank" rel="noopener noreferrer" class="p-0.5 rounded-full hover:bg-white hover:bg-opacity-10 transition-colors">
              <img src="public/icons/link.svg" alt="Demo Link" class="h-3 w-3" width="12" height="12">
            </a>
          ` : ''}
          ${project.freelance ? `
            <span class="p-0.5 rounded-full hover:bg-white hover:bg-opacity-10 transition-colors">
